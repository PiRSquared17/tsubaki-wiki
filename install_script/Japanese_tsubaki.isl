...
;
;customize for tsubaki-wiki installer 2011-05-05 Yutaka Kachi
...
WelcomeLabel2=このプログラムはご使用のコンピュータへ [name/ver] をインストールします。%n%n続行する前に、XAMPP(http://www.catch.jp/wiki/index.php?xampp)をインストールしてください。

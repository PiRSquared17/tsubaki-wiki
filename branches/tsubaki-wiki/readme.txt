...
とはいえ、現在のバージョン(0.4)は、アルファモデルというべき存在です。そのため、あまり多機能ではありません。見栄えもイマイチです。でも、オープンソース・ソフトウェアとして誰でも自由に改良できるので、皆さんの力を借りて、育てていきたいと考えています。どうぞ、よろしくお願いします。
